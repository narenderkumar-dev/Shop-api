...
const CreateProductForm = () => {
  ...
  return (
    <div className=''>
      ...
      <form onSubmit={handleSubmit} className="createProductContainer min-h-screen p-10">
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
          <TextField fullWidth label="Quantity" name='quantity' value={productData.quantity} onChange={handleChange} type='number' required/>
          </Grid>
          <Grid item xs={12} sm={4}>
          <TextField fullWidth label="Price" name='price' value={productData.price} onChange={handleChange} type='number' required/>
          </Grid>
          <Grid item xs={12} sm={4}>
          ...
          <Grid item xs={12} >
          <TextField fullWidth id="outlined-multiline-static" label='Description' multiline name='description' rows={3}  value={productData.description} onChange={handleChange} required/>
          </Grid>
