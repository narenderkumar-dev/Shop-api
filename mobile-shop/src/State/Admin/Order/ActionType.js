...
export const PLACED_ORDER_FAILURE = 'PLACED_ORDER_REQUEST';
...
export const DELIVERED_ORDER_FAILURE = 'DELIVERED_ORDER_REQUEST';
...
export const CANCELED_ORDER_FAILURE = 'CANCELED_ORDER_REQUEST';

// Action Types for DELETE order
export const DELETE_ORDER_REQUEST = 'DELETE_ORDER_REQUEST';
export const DELETE_ORDER_SUCCESS = 'DELETE_ORDER_SUCCESS';
export const DELETE_ORDER_FAILURE = 'DELETE_ORDER_REQUEST';

// Action Types for SHIP order
export const SHIP_ORDER_REQUEST = 'SHIP_ORDER_REQUEST';
export const SHIP_ORDER_SUCCESS = 'SHIP_ORDER_SUCCESS';
export const SHIP_ORDER_FAILURE = 'SHIP_ORDER_REQUEST';