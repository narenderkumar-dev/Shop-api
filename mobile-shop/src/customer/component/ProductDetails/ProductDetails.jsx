...
// import findProductsById from '../../../State/Order/Action'
...
export default function ProductDetails(product) {
  ...
  console.log("detail page pe product",products);
      ...
      <div className="pt-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap space-x-5 justify-center">
            {products.images?.map((item)=> <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[4rem] max-h-[4rem] mt-4">
              <img
                src={item.src}
                alt={item.alt}
                className="h-full w-full object-cover object-center"
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 text-sm'>50540 Ratings</p>
            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3034 Reveiws</p>
              </div>
            </div>
        ...
        <section className='pt-10'>
          ...
          <div className="flex flex-wrap space-y-5 ">
            {mens_kurta.slice(0,4).map((item)=><SimiliarProduct product={item}/>)}
          </div>
        </section>
      </div>
    </div>
...
//   // const product = products.product?.content || {};
//   // console.log("Products in component:", product);
//   // const productList = products.product?.content || [];
...
//   //   dispatch(findProductsById(data))
//   // },[params.productId])
//   const productList = products.product?.content.find((p) => p._id === productId) || {};
//   console.log("Products in component 2 line:",productList);
...
//         <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
//           <div className="lg:col-span-2 ">
//             <h1 className="text-lg lg:text-xl font-semibold text-gray-900 ">{productList.brand}</h1>
//             <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">{productList.title}</h1>
//           </div>
